...
### Bright Data Hosted MCP (already wired in this repo)

`src/server.ts` is preconfigured to connect to Bright Data MCP when
...
3. Ask the agent something that needs live web data, for example:
