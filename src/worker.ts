...
async function runStep1OpenAiTop20Finalization(
  ...
  const prompt = [
    ...
    "4) Use only services likely present from provided data (serviceTerms/topPages). If unclear, omit.",
    "5) Create a balanced mix (IMPORTANT):",
    "   - 4–6 branded keywords (no location required).",
    "   - 8–10 localized \"service + geo\" money keywords.",
    "   - 3–5 non-geo service keywords OR \"near me\" keywords (choose what's most realistic).",
    "6) Geo variety constraint (IMPORTANT):",
    "   - Use \"{city}\" only in 4–6 keywords,",
    "   - Use \"{city} {state}\" in 3–5 keywords,",
    "   - Use \"near me\" in 2–4 keywords,",
